...
const Login = () => {
 ...
 const { backendUrl, token, setToken, showNotification } = useContext(AppContext) || {};
 ...
 const onSubmitHandler = async (event) => {
  ...
  try {
   ...
   if (data.success) {
    ...
    // REPLACED toast.success with showNotification('message', 'success')
    ...
    // REPLACED toast.error with showNotification('message', 'error')
