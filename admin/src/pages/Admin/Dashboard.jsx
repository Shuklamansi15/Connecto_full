...
const Dashboard = () => {
    ...
    // 🚀 FIX 2: Defensive check for initial state and structure
    ...
    // Prepare the consultations list with a defensive check
    ...
    return (
        <div className='m-5'>
            ...
            <div className='bg-white mt-10 rounded-b'>
                ...
                {/* Table Header mirroring AllConsultations */}
                ...
                <div className='pt-4 border border-t-0 text-sm max-h-[400px] overflow-y-auto'>
                    ...
                    {/* 🚀 FIX 3: Use the defensively checked array (latestConsultations) */}
                    {latestConsultations.slice(0, 5).map((item, index) => {

                        // Data extraction using defensive checks
                        const influencer = item.infData || {};
                        const user = item.userData || {};
                        
                        const influencerName = influencer.name || "Unknown Influencer";
                        const influencerImage = influencer.image || assets.default_user; // Use a default asset
                        const userName = user.name || "Unknown User";
                        const userImage = user.image || assets.default_user; // Use a default asset
